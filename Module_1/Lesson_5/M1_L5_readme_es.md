# Lección 5: Planificar la Ciencia Abierta: de la teoría a la práctica
...
Este módulo está casi terminado, pero hay mucha más información disponible sobre la Ciencia Abierta, así que nuestra última lección es para quienes quieran aprender más. En esta lección revisaremos formas de comenzar nuestro viaje hacia la Ciencia Abierta, incluyendo una lista de recursos que podemos usar desde ahora.
...
- Diferenciar ejemplos del mundo real acerca de cómo un equipo puede practicar Ciencia Abierta.
- Enumerar cuatro pasos que cualquier persona puede seguir para tener un enfoque más abierto.
...
Los organismos de financiamiento y patrocinadores consideran que la gestión de los datos es crucial para la Ciencia Abierta porque asegura que los datos de la investigación están bien organizados, accesibles y preservados. Durante los últimos años, muchos han incorporado un Plan de Ciencia Abierta y Gestión de Datos (PCAGD) como requisito para la presentación de proyectos. 

Un Plan de Ciencia Abierta y Gestión de Datos puede confundirse con el Plan de Gestión de Datos (PGD, en inglés, Data Management Plan, DMP). El PCAGD incorpora componentes que van más allá del alcance de un PGD. El PCAGD incluye una descripción de los recursos que se utilizarán, los productos que se crearán, cómo se compartirán y quiénes serán las personas responsables. Puede incluir datos, software, publicaciones y aspectos de gobernanza, así como la forma en que se compartirán estos productos con otros equipos de investigación y con el público. Suele presentarse como una sección dentro del paquete de propuesta que describe cómo se planifica, gestiona y entrega todos los productos de investigación de la forma más abierta y públicamente disponible posible.

Los Planes de Ciencia Abierta y Gestión de Datos son esenciales porque mejoran la credibilidad y la reproducibilidad de la investigación al asegurar que los datos, el código y otros productos de investigación estén bien documentados, organizados y preservados a lo largo del tiempo. Los OSDMP bien diseñados pueden producir los siguientes beneficios:
...
Hoy en día, cada vez son más las fundaciones y agencias que esperan que las propuestas para subsidios de investigación incluyan una estrategia de Ciencia Abierta. Al incluir un documento de estrategia de Ciencia Abierta en tu proyecto, aseguras la accesibilidad y apertura en cada paso de tu flujo de trabajo. Concluye tu plan integral con pasos claros para que tus productos de investigación sean fácilmente accesibles y estén abiertamente disponibles. Los pasos definidos en tu estrategia deberían integrarse en tus procesos y prácticas científicas cotidianos.

#### Requerimientos

Todas las importantes fundaciones de investigación y agencias gubernamentales actualmente requieren que las personas solicitantes envíen un Plan de Gestión de Datos (PGD) junto con su proyecto científico y su plan de investigación. Algunas piden detalles adicionales sobre software y código, así como sobre publicaciones. En la estrategia de Ciencia Abierta, es importante asegurarse de cumplir con todos los requisitos de las agencias financiadoras.
...
Continuando con el flujo de trabajo, este diagrama actualizado muestra ahora los tipos de productos científicos que son creados en cada hito. Los productos especializados que crees pueden variar o ser completamente diferentes, pero el foco en el descubrimiento para el público sigue siendo el mismo. Cualquier tipo de producto que crees puede modificarse para apoyar los principios y conceptos de la Ciencia Abierta. El propósito del plan de estudios de esta Introducción a la Ciencia Abierta es identificar dónde e integrar conceptos de Ciencia Abierta en tus productos.
...
En esta sección, presentamos el sistema "Usar, Hacer, Compartir" que puede empezar a aumentar gradualmente tu adopción de la Ciencia Abierta dependiendo de la naturaleza y el alcance de tu proyecto. A lo largo del curso exploraremos cómo puede utilizarse este marco de trabajo para hacer tu ciencia más abierta.

### ¿Qué recursos vas a usar?

Ya existen muchos recursos de Ciencia Abierta para usar. La Ciencia Abierta cuenta ya con una larga historia. Por ejemplo, la ley que creó la NASA establece que debe compartir sus descubrimientos con toda la humanidad, y la agencia ha estado compartiendo sus datos abiertamente en Internet desde la década de 1980. Ahora ya hay más de 100 petabytes de datos de la NASA disponibles abiertamente para su búsqueda, descarga y uso. Más adelante, en el Módulo 3, se presentan ejemplos de estos servicios. Se han desarrollado tecnologías y prácticas alrededor del código que facilitan la colaboración en la construcción de soluciones complejas, cuyos ejemplos se verán en el Módulo 4. Una serie de servicios facilita el intercambio y el descubrimiento de publicaciones con acceso abierto, que se discuten en el Módulo 5.
...
A lo largo del proceso de investigación, habrá diferentes productos y resultados obtenidos. Estos pueden incluir conjuntos de datos, muestras, código, informes, manuscritos, actas de conferencia, entradas de blog y videos. Cada uno de ellos tiene consideraciones distintas sobre cómo crearlos, incluyendo cómo pueden hacerse de forma abierta y colaborativa.

También hay diferentes maneras de dirigir un proyecto científico. ¿Tu proyecto va a ser abierto desde el comienzo o en la publicación? Hay razones válidas para ambas aproximaciones, pero generalmente mientras antes abras los datos, el código y los resultados, más oportunidades tendrás para hacer crecer las redes de colaboración y construir con otras personas (lo que es bastante divertido). A menudo, los investigadores eligen ser abiertos en sus equipos de proyecto durante el desarrollo, el intercambio de datos, el código y los resultados, pero sólo abren el proyecto al mundo una vez que sienten que tienen un resultado en el que pueden confiar. Si bien este enfoque ha sido la “norma” cultural en muchas comunidades, esto está cambiando a medida que los grupos se sienten más cómodos con la apertura temprana en los proyectos y obtienen contribuciones valiosas de otras personas y se construyen nuevas redes de colaboración.

Los módulos 3, 4 y 5 abordarán cómo generar tus datos, tu código y tus resultados abiertos.
...
Este trabajo se llevó a cabo como parte del Programa de Ciencia de Liberación Temprana (ERS) del JWST, en el marco del programa de la Comunidad de Exoplanetas en Tránsito del JWST ERS (ERS-TRANSIT). Se trata de algunos de los primeros datos científicos obtenidos con esta instalación y publicados de forma abierta. Sin embargo, el equipo comenzó su trabajo años antes de las observaciones e incluyó la Ciencia Abierta en cada etapa del proceso. El equipo trabajó en un formato abierto desde la ideación hasta el análisis, pasando por la publicación y la comunicación.

Veamos qué resultados abiertos se obtuvieron y, mientras lo hacemos, echemos un vistazo a las ventajas de hacerlo en cada etapa.
...
Una de las partes más importantes de la puesta en marcha de un proyecto es pensar en quiénes van a trabajar en él y cómo trabajarán juntos. Antes de que se recojan las muestras, antes de que se descarguen los datos, antes de que se escriba el código, ¿cómo trabajarán todos juntos, cuáles serán los roles y responsabilidades, y cómo y cuándo se compartirán los materiales? Esa fue una parte clave en la que este proyecto del JWST acertó.

El equipo inicial, durante la fase de planificación, desarrolló y publicó de forma abierta documentos como el [código de conducta](https://ers-transit.github.io/code-of-conduct.html) y la [política de publicaciones](https://ers-transit.github.io/documents/publication-policy-v1.0.pdf).

En términos simples, el equipo dio la bienvenida a otras personas que quisieran trabajar con ellos, pero al mismo tiempo estableció reglas claras. Y luego, las personas a cargo del proyecto hablaron de esto con el equipo con regularidad, especialmente a medida que este se expandió, para que todo el mundo supiera qué se esperaba de ellos y qué obtendrían a cambio (por ejemplo, crédito).
...
**Más información sobre documentos de colaboración y asignación de crédito en OpenSciency.**

OpenSciency en GitHub  
[HAZ CLIC PARA APRENDER MÁS (ENLACE EXTERNO)](https://opensciency.github.io/sprint-content/open-results/lesson4-opportunities-and-credits.html)
...
Como la mayoría de los datos, JWST es complejo y requiere procesamiento y ciclos de producción de datos. La precisión necesaria para lograr este tipo de detección requiere un análisis detallado de las observaciones y una amplia gama de conocimientos.

Durante la fase de implementación, el equipo colaboró en la creación del software de procesamiento de datos, para que todas las personas se beneficiaran. Imagina el esfuerzo malgastado si las 400 personas hubieran escrito el software por separado. 

El beneficio y el resultado fue que, gracias a este esfuerzo de colaboración, el equipo disminuyó los esfuerzos duplicados, quienes colaboraron obtuvieron crédito por su trabajo, el software fue más preciso, y se aceleró el proceso de generación de datos. [Eureka!](https://github.com/kevin218/Eureka) (enlace externo), se creó de forma abierta, acompañado de [documentación](https://eurekadocs.readthedocs.io/en/latest/) (enlace externo) y de una [publicación con revisión por pares del paquete de software](https://joss.theoj.org/papers/10.21105/joss.04503) (enlace externo).

¡Pero no tuvieron que empezar de cero! El equipo ERS-TRANSIT fue capaz de construir sobre el trabajo de otras personas. El software construido con el [ciclo de procesamiento de software de JWST](https://github.com/spacetelescope/jwst) (enlace externo) fue desarrollado de forma abierta por el equipo de la misión JWST. Además, fueron capaces de construir un ecosistema de software de código abierto mucho más amplio usando Python y Astropy.
...
Durante la fase de lanzamiento, el equipo etiquetó de forma adecuada productos de investigación para su reutilización y reproducibilidad, también se publicaron en foros y repositorios públicos. Los beneficios y resultados incluyeron que quienes colaboraron recibieran crédito por los datos, el código, el software y otros productos de investigación digital que benefician a la comunidad científica. 

Datos, código y software se archivaron de forma abierta en el repositorio general de datos [Zenodo](https://zenodo.org/communities/ers-transit) (enlace externo), mientras que la publicación estuvo disponible como [preimpresión](https://arxiv.org/abs/2208.11692) (enlace externo) y como [publicación de acceso abierto](https://www.nature.com/articles/s41586-022-05269-w) (enlace externo).


Al hacer que tus resultados estén disponibles de forma abierta, también accedes a formas más claras de obtener reconocimiento y puedes reducir el riesgo de apropiación (ya que cada resultado puede ser referenciado individualmente tan pronto como esté disponible). Aplicar prácticas de reproducibilidad por separado en diferentes partes del proyecto como documentos de preparación, conjuntos de datos, software, y reportes permite a otras personas investigadoras probar y reutilizar tu trabajo en su investigación. De esta forma se citarán más a menudo tus investigaciones, aportando así un reconocimiento justo a tu trabajo. Las personas que colaboran pueden estar más motivadas a contribuir porque pueden obtener fácilmente reconocimiento de autoría por sus contribuciones a cada resultado obtenido en la investigación.

**Más información sobre cómo abrir los resultados a lo largo del proceso de investigación en OpenSciency**

OpenSciency en GitHub  
[HAZ CLIC PARA APRENDER MÁS (ENLACE EXTERNO)](https://opensciency.github.io/sprint-content/open-results/lesson2-results-and-open-science.html#what-are-the-advantages-of-making-results-open-throughout-the-research-process)
...
### Identificar tus comunidades de Ciencia Abierta
...
- Investiga comunidades en línea que promueven la Ciencia Abierta, como por ejemplo:
  - El programa “[Foster Open Science](https://www.fosteropenscience.eu/)” de la Unión Europea (enlace externo, en inglés),
  - El manual online [The Turing Way](https://the-turing-way.netlify.app/index.html) (enlace externo, en inglés),
  - [FORRT](https://forrt.org/) (enlace externo, en inglés),
  - [MetaDocencia](https://www.metadocencia.org/) (enlace externo, en inglés).
...
- Foro de discusión de la Open Science Framework: [Open Science Framework's discussion board](https://groups.google.com/g/openscienceframework?pli=1) (enlace externo, en inglés).
- Lista de comunidades de Ciencia Abierta de Opensciency: [community list](https://opensciency.github.io/sprint-content/open-tools-resources/lesson5-open-science-communities.html#communities-of-practice-list) (enlace externo, en inglés).
...
- [Buscador de descubrimientos científicos (Science Discovery Engine)](http://science.data.nasa.gov/search) (en inglés)
- [https://data.nasa.gov/](https://data.nasa.gov/) (en inglés)

### Tres pasos para abrir la ciencia que cualquiera puede dar
...
A lo largo del curso se mencionan diversos artículos científicos. Dependiendo del artículo, puede tratarse de una publicación de pago. Si se desea obtener una copia del artículo, se puede contactar a las personas autoras o buscarlo en un archivo de preimpresiones en línea. Por ejemplo, [bioRxiv.org](http://biorxiv.org/) (enlace externo).

## Lección 5: Resumen

No hay una única forma de hacer Ciencia Abierta y cualquier paso que se dé para hacer que la ciencia sea más abierta es extremadamente valioso, especialmente a medida que hacemos la transición a un ecosistema científico más abierto en el futuro. Queremos que las personas puedan identificar las cosas más importantes que "pueden" compartir abiertamente, con el objetivo final de una apertura total.
...
- Los Planes de Ciencia Abierta y Gestión de Datos (OSDMP, por sus siglas en inglés) proporcionan un plan sobre cómo se integra la Ciencia Abierta en un proyecto, incluido el intercambio de datos, código, software y resultados.
...
- Hay más oportunidades para participar y aprender acerca de Ciencia Abierta. Esta lección es solo el comienzo.
...
- Considerar oportunidades para obtener mayores ventajas colaborativas.
...
¿Cuál de las siguientes opciones NO forma parte de los tres pasos hacia la Ciencia Abierta que cualquier persona puede dar?

Seleccionar una opción:

A. Pregunta a tus colegas sobre actividades científicas abiertas y otórgales crédito en las evaluaciones.
B. Piensa en los diferentes tipos de revisiones en las que participas y en cómo mejorarlas para lograr la apertura.
C. Crea una nueva revista que requiera una suscripción costosa para su lectura.
D. Continúa buscando las mejores prácticas para Ciencia Abierta y desarrolla planes para una mayor apertura de tu ciencia o investigación.
...
[APRENDE MAS](http://ec.europa.eu/)

**¿Qué es la Ciencia Abierta?**

[APRENDE MAS](https://blog.f1000.com/2014/11/11/what-is-open-science/)

**Recursos para Ciencias de la Tierra**

[APRENDE MAS](https://www.earthdatascience.org/)

### Referencias

OpenSciency Contributors (2023, 22 de febrero). Opensciency - A core open science curriculum by and for the research community. Zenodo. DOI 10.5281/zenodo.7392118 [https://doi.org/10.5281/zenodo.7392118](https://doi.org/10.5281/zenodo.7392118) (enlace externo)

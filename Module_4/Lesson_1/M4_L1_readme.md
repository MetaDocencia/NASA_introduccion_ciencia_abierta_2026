...
Image credit: NASA GSFC/CIL/Adriana Marique Gutierrez

Most space telescope data is embargoed for twelve months with only the lead scientist and their selected team allowed to work with the data. In a unique case, a small portion of data from NASA's new James Webb Space Telescope (JWST) offered an early-release program. This JWST data was made available immediately.

How scary is that? Everyone you know is going to have access at the exact same time. The anxiety and stress of feeling that you might not have a job if you don't publish first, or that you might not have the next job that you want, could be immense.
...
New open-source sets of climate models incorporate features that aim to make climate research more collaborative, efficient, and reliable. (Junker, 2018)

Scientists have published an open-source framework of climate models [(Isca)](https://execlim.github.io/IscaWebsite/) (external link), which contains models that are easy to obtain and are completely free, documented, and come with software to make installation and operation easier. All changes are documented and can be reverted. Therefore, anyone can easily use the same models.
...
New research across all of these fields was possible within only one year of Isca's publication. This is how we want all of science to work!
...
- Firefox and Chrome
  ...
  - Chrome's engine is Chromium which is forked from WebKit, which itself was forked from KHTML. This was possible because it had a license that allowed for this type of reuse. All major browsers today except Firefox can be traced back to KHTML.
...
[F Prime](https://nasa.github.io/fprime/) - Space mission flight software
...
- [PODAAC](https://github.com/podaac) (external link) – Distributed archiving and processing software
- [UFS](https://github.com/ufs-community) (external link) – Operational weather forecasting model software
- Metadata Compliance Checker, APIs, Web apps, [Giovanni](https://www.earthdata.nasa.gov/technology/giovanni), [McIDAS](https://en.wikipedia.org/wiki/McIDAS) (external link)
...
- [NumPy](https://github.com/numpy) (external link) – Scientific computing with python
- [scikit-image](https://github.com/scikit-image/) (external link) – Image processing algorithms in python
- [deal.II](https://github.com/dealii/dealii) (external link) – Library of algorithms to solve partial differential equations with finite elements
...
- [OpenFOAM](https://github.com/OpenFOAM) (external link) – Computational fluid dynamics software
- [MOM6](https://github.com/mom-ocean/MOM6) (external link) – General ocean circulation model
- [ASPECT](https://github.com/geodynamics/aspect) (external link) – Planetary convection software
...
- [Photutils](https://photutils.readthedocs.io/en/stable/index.html) (external link) – tools for detecting and performing photometry of astronomical sources
...
- [Angus et al. 2019](https://ui.adsabs.harvard.edu/abs/2019AJ....158..173A/abstract) (external link) – [Fitting a gyro relation to Praesepe](https://github.com/RuthAngus/stardate/blob/master/paper/code/Fitting_Praesepe.ipynb) (external link)
- [Webb telescope spots CO2 on exoplanet for the first time: what it means for finding alien life](https://www.nature.com/articles/d41586-022-02350-2) (external link). All the data and models presented in this publication can be found [here](https://doi.org/10.5281/zenodo.6959427) (external link).
- Code at: [https://doi.org/10.5281/zenodo.6288035](https://doi.org/10.5281/zenodo.6288035) (external link) (2022)

## Principles, Benefits, and Challenges

### Principles of Open Code

According to The open source way, successful open-source software models can be used to derive a set of five principles for practicing open code. They establish guidelines that advance open science and aim to enhance the value and impact of research.
...
| Share early and often | Rapid prototypes can lead to rapid discoveries. An iterative approach leads to better solutions faster. When you're free to experiment, you can look at problems in new ways and seek answers in new places. |
| The best ideas should win | Good ideas can come from anywhere, and the best ideas should win. Only by including varied perspectives in our conversations can we be certain we've identified the best ideas, and good decision-makers continually seek those perspectives. We may not operate by consensus, but successful work determines which projects gather support and effort from the community. |
...
[IMG: https://drive.google.com/file/d/1KA0MtQ1ZmJJEWuaAxhL5Vikqbw6Oq-OR/view?usp=drive_link]
Image Credit: NASA
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Open Software developers can gain visibility & sustainability of their code</td>
    </tr>
  </tbody>
</table>
...
*Software is referred to as open source when it is publicly accessible and anyone can see, modify, and distribute the code as they see fit within the constraints set by the software license.*
...
- Where software or code will be shared and archived
...
- Jucker, M. (2018, March 6). Making climate models open source makes them even more useful. The Conversation. [https://theconversation.com/making-climate-models-open-source-makes-them-even-more-useful-90929](https://theconversation.com/making-climate-models-open-source-makes-them-even-more-useful-90929) (external link)

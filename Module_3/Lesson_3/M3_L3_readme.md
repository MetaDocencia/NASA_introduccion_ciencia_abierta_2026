...
| Common Data Format (CDF) | For self-describing format readable across multiple operating systems, programming languages, and software environments, multidimensional data, and metadata. |
...
Image credit: XKCD licensed under CC BY-NC 2.5 DEEX.
...
Image Credit: "Black and Blue Framed Eyeglasses on Silver Laptop" by Alexandr Bricky, via [Pexels](https://www.pexels.com/photo/black-and-blue-framed-eyeglasses-on-silver-laptop-393044/) (external link)

"By applying a license to your work, you make clear what others can do with the things you're sharing, and also the conditions under which you're providing them. (DeHaven, 2020) You can also require others who copy your work to do things in return."
...
Image Source: "An IPCC Special Report" by ResearchGate
...
- DeHaven, Alexander. (2020, March 18). Getting Started with OSF. Center for Open Science. [https://www.cos.io/blog/getting-started-osf](https://www.cos.io/blog/getting-started-osf) (external link)
- PCMDI: Earth System Model Evaluation Project. (2022, October 12). CMIP6: Terms of Use. [https://pcmdi.llnl.gov/CMIP6/TermsOfUse/TermsOfUse6-2.html](https://pcmdi.llnl.gov/CMIP6/TermsOfUse/TermsOfUse6-2.html) (external link)
